<template>
  ...
  >
    ...
    <template v-else-if="name === 'cloud'">
      <path d="M17.5 19H8a5 5 0 1 1 1.3-9.8A6 6 0 0 1 21 12a4 4 0 0 1-3.5 7Z" />
    </template>
    ...
    <template v-else-if="name === 'alert'">
      <path d="M12 9v4" /><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L14.71 3.86a2 2 0 0 0-3.42 0Z" /><path d="M12 17h.01" />
    </template>
